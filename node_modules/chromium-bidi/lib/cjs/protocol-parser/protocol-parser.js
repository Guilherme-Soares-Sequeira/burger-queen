...
(function (BrowsingContext) {
    ...
    const PrintPageParametersSchema = zod_1.z.object({
        height: zod_1.z.number().nonnegative().default(27.94).optional(),
        width: zod_1.z.number().nonnegative().default(21.59).optional(),
    });
    // All units are in cm.
    ...
    const PrintMarginParametersSchema = zod_1.z.object({
        bottom: zod_1.z.number().nonnegative().default(1.0).optional(),
        left: zod_1.z.number().nonnegative().default(1.0).optional(),
        right: zod_1.z.number().nonnegative().default(1.0).optional(),
        top: zod_1.z.number().nonnegative().default(1.0).optional(),
    });
...
(function (Input) {
    ...
    const PointerCommonPropertiesSchema = zod_1.z
        ...
        twist: zod_1.z.number().min(0).max(359).int().default(0),
    })
