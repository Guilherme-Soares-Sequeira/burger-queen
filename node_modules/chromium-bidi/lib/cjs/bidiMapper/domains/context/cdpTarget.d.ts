...
export declare class CdpTarget {
    #private;
    static create(targetId: string, parentTargetId: string | null, cdpClient: CdpClient, cdpSessionId: string, realmStorage: RealmStorage, eventManager: IEventManager, preloadScriptStorage: PreloadScriptStorage, browsingContextStorage: BrowsingContextStorage, logger?: LoggerFn): CdpTarget;
    private constructor();
