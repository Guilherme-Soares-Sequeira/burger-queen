...
export class MutationPoller {
    ...
    async start() {
        const deferred = (__classPrivateFieldSet(this, _MutationPoller_deferred, createDeferred(), "f"));
...
export class RAFPoller {
    ...
    async start() {
        const deferred = (__classPrivateFieldSet(this, _RAFPoller_deferred, createDeferred(), "f"));
...
export class IntervalPoller {
    ...
    async start() {
        const deferred = (__classPrivateFieldSet(this, _IntervalPoller_deferred, createDeferred(), "f"));
