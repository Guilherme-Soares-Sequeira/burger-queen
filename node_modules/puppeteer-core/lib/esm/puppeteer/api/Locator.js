...
export class Locator extends EventEmitter {
    constructor(page, selector, options = {
        ...
        _Locator_ensureElementIsInTheViewport.set(this, async (element, signal) => {
            if (!__classPrivateFieldGet(this, _Locator_options, "f").ensureElementIsInTheViewport) {
                return;
            }
        ...
        _Locator_waitForVisibility.set(this, async (element, signal) => {
            if (__classPrivateFieldGet(this, _Locator_options, "f").visibility === null) {
                return;
            }
        ...
        _Locator_waitForEnabled.set(this, async (element, signal) => {
            if (!__classPrivateFieldGet(this, _Locator_options, "f").waitForEnabled) {
                return;
            }
        ...
        _Locator_waitForStableBoundingBox.set(this, async (element, signal) => {
            if (!__classPrivateFieldGet(this, _Locator_options, "f").waitForStableBoundingBox) {
                return;
            }
    ...
    setVisibility(visibility) {
        __classPrivateFieldGet(this, _Locator_options, "f").visibility = visibility;
        return this;
    }
    setTimeout(timeout) {
        __classPrivateFieldGet(this, _Locator_options, "f").timeout = timeout;
        return this;
    }
    setEnsureElementIsInTheViewport(value) {
        __classPrivateFieldGet(this, _Locator_options, "f").ensureElementIsInTheViewport = value;
        return this;
    }
    setWaitForEnabled(value) {
        __classPrivateFieldGet(this, _Locator_options, "f").waitForEnabled = value;
        return this;
    }
    setWaitForStableBoundingBox(value) {
        __classPrivateFieldGet(this, _Locator_options, "f").waitForStableBoundingBox = value;
        return this;
    }
...
async function _Locator_waitForFunction(fn, signal, timeout = CONDITION_TIMEOUT) {
    ...
    }, options?.signal, __classPrivateFieldGet(this, _Locator_options, "f").timeout);
};
