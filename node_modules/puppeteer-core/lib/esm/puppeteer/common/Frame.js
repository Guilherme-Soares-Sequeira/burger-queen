...
export class Frame extends BaseFrame {
    ...
    async addScriptTag(options) {
        ...
        return this.worlds[MAIN_WORLD].transferHandle(await this.worlds[PUPPETEER_WORLD].evaluateHandle(async ({ createDeferred }, { url, id, type, content }) => {
    ...
    async addStyleTag(options) {
        ...
        return this.worlds[MAIN_WORLD].transferHandle(await this.worlds[PUPPETEER_WORLD].evaluateHandle(async ({ createDeferred }, { url, content }) => {
            const deferred = createDeferred();
            let element;
            if (!url) {
