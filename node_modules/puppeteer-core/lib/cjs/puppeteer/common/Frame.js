...
class Frame extends Frame_js_1.Frame {
    ...
    async addScriptTag(options) {
        ...
        return this.worlds[IsolatedWorlds_js_1.MAIN_WORLD].transferHandle(await this.worlds[IsolatedWorlds_js_1.PUPPETEER_WORLD].evaluateHandle(async ({ createDeferred }, { url, id, type, content }) => {
    ...
    async addStyleTag(options) {
        ...
        return this.worlds[IsolatedWorlds_js_1.MAIN_WORLD].transferHandle(await this.worlds[IsolatedWorlds_js_1.PUPPETEER_WORLD].evaluateHandle(async ({ createDeferred }, { url, content }) => {
            const deferred = createDeferred();
            let element;
            if (!url) {
