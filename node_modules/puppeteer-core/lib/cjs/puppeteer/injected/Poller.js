...
class MutationPoller {
    ...
    async start() {
        const deferred = (__classPrivateFieldSet(this, _MutationPoller_deferred, (0, Deferred_js_1.createDeferred)(), "f"));
...
class RAFPoller {
    ...
    async start() {
        const deferred = (__classPrivateFieldSet(this, _RAFPoller_deferred, (0, Deferred_js_1.createDeferred)(), "f"));
...
class IntervalPoller {
    ...
    async start() {
        const deferred = (__classPrivateFieldSet(this, _IntervalPoller_deferred, (0, Deferred_js_1.createDeferred)(), "f"));
